...
namespace ProductTracking.Controllers.Auth
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                MembershipUser ldapUser = Membership.GetUser(model.UserName);
                ApplicationUser user = userService.SyncLdapUser(ldapUser.UserName, ldapUser.Email, model.Password, UserManager);
